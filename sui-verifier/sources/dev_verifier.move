module dev::verifier {
     ...
     proof_unlock: vector<u8>, akP_x: vector<u8>, akP_y: vector<u8>, ctx: &TxContext)
    {
        ...
        //assert!(coin::value(&c) > MIST_PER_SUI * 0.1, EInsufficientCollateral);
        ...
        let is_valid_commitment = commit(proof_commit, student_a_hash, student_aH_x, student_aH_y, address::to_bytes(student_address));
        ...
        address::to_bytes(student_address), student_a_hash, *professor_kP_x, *professor_kP_y);
        ...
        table::add(answers, student_address, answer);
    ...
    proof:vector<u8>, professor_out_kaH_x: vector<u8>, professor_out_kaH_y: vector<u8>, ctx: &mut TxContext)
    {
        ...
        let Quest {id: _, question: _, professor_address, professor_k_hash,
            professor_kP_x: _, professor_kP_y: _, answers} = shared_quest;
    ...
    public entry fun student_get_timeout_reward(shared_quest: &Quest, ctx: &TxContext)
    {
